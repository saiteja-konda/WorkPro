...
import dev.teja.projectboard.service.CustomUserDetailsService;
...
import static dev.teja.projectboard.Security.SecurityConstants.HEADER_STRING;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, FilterChain filterChain) throws ServletException, IOException {
        try {
            ...
            logger.error("Could not authenticate user in thr given Security context", ex);
        }
